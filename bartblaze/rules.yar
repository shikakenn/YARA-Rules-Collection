...
rule RoyalRoad_RTF
{
    meta:
        ...
        fingerprint = "v1_sha256_88d8e1ba8c39f48f53867fbac897f6d9c53fa65526429e4fcec5a6983b59a160"
        version = "1.0"
        date = "2020-01-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule BroEx
{
    meta:
        ...
        fingerprint = "v1_sha256_39899414ad682722b2dfe8b7f8e90408ca3fe2b0afbbaf9980442776d1e07ddc"
        version = "1.0"
        modified = "2023-09-18"
        status = "RELEASED"
        sharing = "TLP:WHITE"
...
rule CrunchyRoll
{
    meta:
        ...
        fingerprint = "v1_sha256_2138304ff8be89204d12120f97b1f45716a65a783e8406dbaf9cc13081abf772"
        version = "1.0"
        date = "2019-11-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule JSSLoader
{
    meta:
        ...
        fingerprint = "v1_sha256_022bb59c902b4dec9c7d4b36670dc11ae3bcad300e09245ed11db1a35fd54825"
        version = "1.0"
        date = "2021-06-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule MalScript_Tricks
{
    meta:
        ...
        fingerprint = "v1_sha256_7ea0c2a8321c8c0f9195a781351f136c2913b9f4b495ca8635722c8acc498622"
        version = "1.0"
        date = "2020-12-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule oAuth_Phishing_PDF
{
    meta:
        ...
        fingerprint = "v1_sha256_54c8708cd43a3f858bbab037793aae08b4f79a905f803a15e6b00a4124852ae5"
        version = "1.0"
        date = "2022-01-01"
        modified = "2022-02-03"
        status = "RELEASED"
...
rule Gmer
{
    meta:
        ...
        fingerprint = "v1_sha256_1ee87b1a8423b7bc9161db217040d3a3608fade30d26ad170aec0d1beab012be"
        version = "1.0"
        date = "2021-07-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule Gmer_Driver
{
    meta:
        ...
        fingerprint = "v1_sha256_ebaf2d7bf149d70366f687b6723e8275f2af6895549d3bdb607e2b5c5f915644"
        version = "1.0"
        date = "2021-07-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
}rule IISRaid
{
    meta:
        ...
        fingerprint = "v1_sha256_0539d201258b4f9a15b21eaf2cb0ea34685467ca087345819a9f15816fa64cf2"
        version = "1.0"
        date = "2021-08-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
rule PowerTool
{
    meta:
        ...
        fingerprint = "v1_sha256_d80a8d785ca059a32034d59aa581e3112aeeb3fb721df617e053e41c1f6d2fda"
        version = "1.0"
        date = "2021-07-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
}rule DearCry
{
    meta:
        ...
        fingerprint = "v1_sha256_02769129c059b1f9e2e502df5244a2945f59c8c4154059b75bbc5d4b115af295"
        version = "1.0"
        date = "2021-03-01"
        modified = "2021-12-30"
        status = "RELEASED"
...
}rule Sfile
{
    meta:
        ...
        fingerprint = "v1_sha256_83dd8af4a5a175772b5db0e11be7f79f3e5744deb2b995900858ee4cb96912d2"
        version = "1.0"
        date = "2020-09-01"
        modified = "2021-12-30"
        status = "RELEASED"
