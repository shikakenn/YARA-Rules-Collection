rule win_koadic_auto {
    ...
    meta:
        id = "2beVFnRTcsf1urWkA7OYGn"
        fingerprint = "v1_sha256_045758b315b8841fdc586ed89736311e4ca424527e393ec057e76ad188d18c25"
        version = "1"
        date = "2024-10-31"
        modified = "2025-04-03"
        status = "RELEASED"
    ...
    strings:
        ...
        $sequence_1 = { 7419 0fb608 33ce 81e1ff000000 c1ee08 33348d48154100 40 }
            ...
            //   c1ee08               | shr                 esi, 8
            //   33348d48154100       | xor                 esi, dword ptr [ecx*4 + 0x411548]
            //   40                   | inc                 eax
